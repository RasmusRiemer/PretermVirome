...
map_mat <- read.delim('mapping_bacteria_randomized.txt', sep = '\t', stringsAsFactors = FALSE, check.names = FALSE, row.names = 1)
...
map_mat <- read.delim('mapping_virome_randomized.txt', sep = '\t', stringsAsFactors = FALSE, check.names = FALSE, row.names = 1)
